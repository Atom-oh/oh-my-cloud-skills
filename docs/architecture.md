...
| co-agent | 멀티-AI 협업 — 리뷰/의사결정/ADR/컨텍스트 동기화 (1 agent, 1 skill, 5 commands) | Kiro/Codex/Antigravity CLI |
...
| co-agent | Multi-AI collaboration — review/decide/ADR/sync-context (1 agent, 1 skill, 5 commands) | Kiro/Codex/Antigravity CLI |
