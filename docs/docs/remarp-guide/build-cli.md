...
# 출력 디렉토리 지정
python3 remarp_to_slides.py build my-talk.remarp.md -o ./output/
```
...
```
my-presentation/
├── _presentation.remarp.md   # 글로벌 설정 (필수)
...
```bash
python3 remarp_to_slides.py build my-talk.remarp.md --format pdf
```
