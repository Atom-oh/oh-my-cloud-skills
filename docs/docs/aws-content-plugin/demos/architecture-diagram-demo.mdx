...
<DemoEmbed
  ...
  title="3-Tier VPC Architecture — Draw.io Style SVG Rendering"
  height="600px"
  command="architecture-diagram-agent가 .drawio XML 생성 → SVG/PNG 내보내기"
/>
...
아래는 생성된 3-Tier 아키텍처 다이어그램의 스크린샷입니다:

![3-Tier VPC Architecture](/img/demos/arch-diagram-3tier.png)
