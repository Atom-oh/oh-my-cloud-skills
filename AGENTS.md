<!-- generated-by: co-agent · source: CLAUDE.md · claude-md-sha: 134e6b17c1cb · generated-at: 2026-09-13 · DO NOT EDIT — edit CLAUDE.md then run /co-agent sync-context -->
...
- Versions agree across manifests/registries; release tags need not change per PR.
  Follow `docs/reference/review-routing.md`: content rubric PASS, deployment >=85,
  diagram XML/layout >=80, Remarp validation before build.
