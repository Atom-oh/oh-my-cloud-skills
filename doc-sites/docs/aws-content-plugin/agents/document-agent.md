...
<span id="step-2-structure-planning" />
<span id="step-3-content-creation" />
<span id="step-4-diagram-integration" />
<span id="문서-템플릿" />
<span id="technical-report" />
<span id="solution-comparison" />
<span id="콘텐츠-품질-규칙" />
<span id="가독성" />
<span id="데이터-인용" />
<span id="약어" />
<span id="이미지-alt-text-wcag-21" />
<span id="콘텐츠-제외-규칙" />
<span id="출력물" />
<span id="사용-예시" />
<span id="협업-워크플로우" />
...
[Agent contract](https://github.com/Atom-oh/oh-my-cloud-skills/blob/main/plugins/aws-content-plugin/agents/document-agent.md)
