...
Circular nodes use the legacy static syntax. They do not accept an ID or a `step`
attribute; use boxes when the node needs arrow connections or progressive reveal.
