...
Also triggers on 'kiro한테 시켜서 구현', 'kiro한테 구현 위임', 'kiro implement this'. Read-only diff review is the separate /kiro:review command, which never loads this write-capable pipeline.
