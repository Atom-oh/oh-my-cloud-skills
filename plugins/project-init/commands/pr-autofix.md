...
4. If any review is blocking → read issues, plan fixes on Fable/Opus, implement the plan with sonnet subagents in an isolated git worktree (parallel on disjoint files), land only the plan-approved delta, verify build, commit, push
