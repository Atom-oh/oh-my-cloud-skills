---
description: Generate or update a bilingual (English/Korean) CHANGELOG.md following Keep a Changelog and Semantic Versioning — the changelog step before superpowers:finishing-a-development-branch
