...
export class RemarpCompletionProvider implements vscode.CompletionItemProvider {
    ...
    private readonly cssTargets: string[] = [
        'header', 'footer', 'body', 'left', 'right',
        'card:N', 'li:N', 'cell:N', 'col:N', 'tab:N', 'step:N', 'option:N',
        'canvas:ID'
    ];

    private readonly cssProperties: { name: string; description: string; snippet?: string }[] = [
    ...
    private _isInCssBlock(document: vscode.TextDocument, position: vscode.Position): boolean {
    ...
    private _isInCssTargetBlock(document: vscode.TextDocument, position: vscode.Position): string | null {
    ...
    private _getCssCompletions(document: vscode.TextDocument, position: vscode.Position, linePrefix: string): vscode.CompletionItem[] {
