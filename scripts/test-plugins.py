...
# The generated Codex adapter is separate from these upstream-owned sources.
...
def main():
    ...
    plugins = ["aws-content-plugin", "aws-ops-plugin", "kiro-power-converter", "co-agent", "agentcore-creator", "project-init", "kiro", "atlas"]
    if args.plugin:
